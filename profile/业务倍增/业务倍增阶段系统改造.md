...
改造前：  
<img src="../成立初期/imgs/成立初期系统设计-系统架构图.png" width="700" alt="成立初期系统设计-系统架构图"/>

改造后：  
<img src="./imgs/系统架构图.png" width="800" alt="业务倍增阶段-系统架构图"/>

### 1.2. 部署方式对比

改造前：  
<img src="../成立初期/imgs/成立初期系统设计-部署图1.png" width="650" alt="成立初期系统设计-部署图1"/>

改造后：  
<img src="./imgs/部署图.png" width="800" alt="业务倍增阶段-部署图"/>
...
<img src="./imgs/Redis集群部署.png" width="450" alt="Redis集群部署"/>
...
<img src="./imgs/缓存变化小的数据.png" width="600" alt="缓存变化小的数据"/>
